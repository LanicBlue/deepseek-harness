...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  LaneKey: 'provider route key is owned by packages/llm/llm-scheduler/src/types.ts',
  LaneConfig: 'lane admission policy is owned by packages/llm/llm-scheduler/src/types.ts',
  SchedulerStatus: 'scheduler status snapshot is owned by packages/llm/llm-scheduler/src/types.ts',
  RouteFacts: 'scheduler routing event facts are owned by packages/llm/llm-scheduler/src/types.ts',
  DecideFacts: 'scheduler adjudication event facts are owned by packages/llm/llm-scheduler/src/types.ts',
  FailureDecision: 'failure disposition decision is owned by packages/llm/llm-scheduler/src/types.ts',
