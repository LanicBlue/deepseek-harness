...
flowchart LR
  ...
  plugin_dsh_base_llm_scheduler["llm-scheduler<br/>@deepseek-ai/dsh-llm-scheduler"]
  cfg --> plugin_dsh_base_llm_scheduler
...
| `llm-scheduler` | `@deepseek-ai/dsh-llm-scheduler` |
